...
class KategoriController extends Controller
{
    ...
    {
        $request->validate([
            'kategori_kode' => 'required|string|min:2|max:4|unique:m_kategori,kategori_kode',
    ...
    {
        $request->validate([
            'kategori_kode' => 'required|string|min:2|max:4|unique:m_kategori,kategori_kode,' . $id . ',kategori_id',
